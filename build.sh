...
# Bundle the hook scripts (so first-launch self-install works), quota helper, and app icon.
...
if [[ -n "$SIGN_ID" ]]; then
  ...
  echo "No Developer ID cert configured — ad-hoc signing (local dev build)."
